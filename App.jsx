  ...
  useEffect(() => {
    const authenticateUser = async () => {
      try {
        ...
        console.log('Initialization or authentication failed with error:', error);

        if (error && error.hasOwnProperty('reason') && error.reason === AuthFailureReason.AUTH_TOKEN_NOT_PROVIDED) {
